...
public abstract class ABaseTransformer implements PageTransformer {
    ...
    /**
     * Called each {@link #transformPage(View, float)} before {{@link #onTransform(View,
     * float)}.
     * <p/>
    ...
    /**
     * Called each {@link #transformPage(View, float)} after {@link #onTransform(View,
     * float)}.
     *
     * @param page     Apply the transformation to this page
     * @param position Position of page relative to the current front-and-center position of the pager. 0 is front and
    ...
    /**
     * Same as {@link Math#min(double, double)} without double casting, zero closest to infinity handling,
     * or NaN support.
     *
     * @param val
     * @param min
